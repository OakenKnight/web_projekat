        ...
        <div id="start">
            <div class="container-fluid">
                ...
                <div class="bk-img row justify-content-center">
                    <div class="search-form col-md-4">
                            <form class="search" action="!#">
                                <input class="search-destination" type="text" name="place" placeholder="Search destination">
                                <div>
                                    <div class="datepicker">
                                        <vuejs-datepicker :disabled-dates="disabledArriveDates" format="dd.MM.yyyy" placeholder="Arrive" v-model="arriveDate" ></vuejs-datepicker>
                                    </div>
                                    <div class="datepicker">
                                        <vuejs-datepicker :disabled-dates="disabledDepartDates" format="dd.MM.yyyy" placeholder="Depart" v-model="departDate"></vuejs-datepicker>
                                    </div>
                                    <select required>
                                ...
                                <input name="search-btn" id="search-btn" class="btn btn-block" type="button" value="Search">
                            </form>
                        </div>
                    </div>
                </div>
                <div class="info">
                    ...
                    <h1 id="recomended">Recomended Apartment</h1>
                    <div class="row">
